...
_app_dir = Path(__file__).resolve().parent  # api/app/ or backend/app/
_project_root = _app_dir.parent.parent      # project root

# On Vercel: data is at api/data/ (deployed with the function)
# Local: data is at backend/data/
VERCEL_DATA = _app_dir.parent / "data"  # api/data/
LOCAL_DATA = _project_root / "backend" / "data"

DATA_DIR = VERCEL_DATA if VERCEL_DATA.exists() else LOCAL_DATA
HISTORY_DIR = DATA_DIR / "history"
FALLBACK_FILE = DATA_DIR / "fallback_sample.xlsx"
DB_PATH = _project_root / "backend" / "kifayat.db"
